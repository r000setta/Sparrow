...
{
	mShaders["standardVS"] = d3dUtil::CompileShader(L"D:\\Sparrow\\dx12Demo\\shader\\shapes.hlsl", nullptr, "VS", "vs_5_1");
	mShaders["opaquePS"] = d3dUtil::CompileShader(L"D:\\Sparrow\\dx12Demo\\shader\\shapes.hlsl", nullptr, "PS", "ps_5_1");
...
{
	std::ifstream fin("D:\\Sparrow\\models\\skull.txt");
	if (!fin)
	{
	...
	for (UINT i = 0; i < vertexCount; ++i) {
		...
		fin >> ignore >> ignore >> ignore;	//²»¶ÁÈ¡normal
		vertices[i].Color = XMFLOAT4(DirectX::Colors::CadetBlue);
	}
